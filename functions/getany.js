...
async function getStories(username) {
  ...
  const data = await fetch(
    `https://www.instagram.com/graphql/query/?query_hash=c9c56db64beb4c9dea2d17740d0259d9&variables={"reel_ids":[${username}],"highlight_reel_ids":[],"precomposed_overlay":false}`,
    {
      headers: {
